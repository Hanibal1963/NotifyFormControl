...
<Guid(NotifyFormControlPackage.PackageGuidString)>
Public NotInheritable Class NotifyFormControlPackage
    Inherits AsyncPackage

    ''' <summary>
    ''' Package guid
    ''' </summary>
    Public Const PackageGuidString As String = "eb781dd7-be0f-4e4c-97da-e170f334045d"
